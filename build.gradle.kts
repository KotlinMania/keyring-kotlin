...
kotlin {
    ...
    swiftExport {
        moduleName = "Keyring"
        flattenPackage = "io.github.kotlinmania.keyring"
    }

    android {
        namespace = "io.github.kotlinmania.keyring"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "keyring-kotlin", version.toString())

    pom {
        name.set("keyring-kotlin")
        description.set("Kotlin Multiplatform port of open-source-cooperative/keyring-rs - Sample code and CLI for the Rust Keyring")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/keyring-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/keyring-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/keyring-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/keyring-kotlin.git")
        }
    }
}
