...
This file is the quick-reference operating contract for keyring-kotlin. The longer
...
keyring-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`keyring`](https://crates.io/crates/keyring). Upstream Rust is the behavioral oracle while the
