...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Keyring.swiftmodule/`
...
//      `import Keyring` above would fail at compile time.
//
//   2. The static archive `libKeyring.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Keyring" }` and
...
//      via the `KeyringLibrary` product.
//
...
final class KeyringExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Keyring swift module imported cleanly")
    }
}
